...
- Checkout if you can use some bound to calculate the number of samples you need. See "Algorithmic Transparency viaQuantitative Input Influence", chapter A. Computing Power Indices. They use epsilon-delta approximation and Hoffding bound
...
- How do you want to attribute comparison differences (e.g. Shapley)
